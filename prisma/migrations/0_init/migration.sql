...
-- CreateSchema
CREATE SCHEMA IF NOT EXISTS "henein";

-- CreateSchema
CREATE SCHEMA IF NOT EXISTS "mamudae";
...
-- CreateTable
CREATE TABLE "henein"."categories" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "henein"."characters" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateTable
CREATE TABLE "henein"."profiles" (
    "id" UUID NOT NULL,
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "nickname" TEXT NOT NULL DEFAULT ('guest'::text || nextval('guest_username_seq'::regclass)),
    "profile_img" TEXT,
    "nexon_key" TEXT,
    "master_character" UUID,

    CONSTRAINT "user_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "mamudae"."streamer" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "user_id" UUID,
...
-- CreateIndex
CREATE UNIQUE INDEX "characters_name_key" ON "henein"."characters"("name");

-- CreateIndex
CREATE UNIQUE INDEX "characters_ocid_key" ON "henein"."characters"("ocid");

-- CreateIndex
CREATE UNIQUE INDEX "user_username_key" ON "henein"."profiles"("nickname");

-- CreateIndex
CREATE UNIQUE INDEX "profiles_nexon_key_key" ON "henein"."profiles"("nexon_key");

-- CreateIndex
CREATE UNIQUE INDEX "streamer_nickname_key" ON "mamudae"."streamer"("nickname");
...
-- AddForeignKey
ALTER TABLE "henein"."characters" ADD CONSTRAINT "characters_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "henein"."comments" ADD CONSTRAINT "comments_author_fkey" FOREIGN KEY ("author") REFERENCES "auth"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "henein"."comments" ADD CONSTRAINT "comments_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "henein"."posts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "henein"."posts" ADD CONSTRAINT "posts_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "henein"."posts" ADD CONSTRAINT "posts_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "henein"."categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "henein"."profiles" ADD CONSTRAINT "profiles_master_character_fkey" FOREIGN KEY ("master_character") REFERENCES "henein"."characters"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "henein"."profiles" ADD CONSTRAINT "user_id_fkey" FOREIGN KEY ("id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mamudae"."streamer" ADD CONSTRAINT "streamer_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE RESTRICT ON UPDATE RESTRICT;
